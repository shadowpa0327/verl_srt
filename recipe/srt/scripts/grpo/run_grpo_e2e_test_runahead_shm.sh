#!/bin/bash
# SRT E2E Test Script (Runahead + Shared Memory Mode)
#
# Tests SRT with both runahead AND shared memory cache mode enabled.
# This is the most advanced configuration combining:
...
python3 -m recipe.srt.main_ppo \
    ...
    trainer.project_name='srt_e2e_test_runahead_shm' \
    trainer.experiment_name='qwen0.5b_srt_runahead_shm' \
