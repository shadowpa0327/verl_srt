...
exp_name='Qwen3_8B-16k-GRPO-DAPO17k-filtered-data-Snapshot-otf'
...
python3 -m recipe.srt.main_ppo \
    ...
    actor_rollout_ref.rollout.cudagraph_capture_sizes=[1,2,4,8,12,16,20,24,28,32,40,48,56,64,80,96,128,160,192,224,256,288,320,384,448,512,576,640,768,896] \
