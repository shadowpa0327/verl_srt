...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen2_7b_1104_suffix_default_d5_no_global_bs1024_o4k' \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=1 \
    trainer.save_freq=20 \
    trainer.test_freq=5 \
    trainer.default_local_dir="/mnt/hdfs/__MERLIN_USER_DIR__/verl_ckpt/qwen2-7b_grpo_gsm8k_suffix_decode_no_global_bs1024" \
