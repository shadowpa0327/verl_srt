#!/bin/bash
# Test script for suffix tree local mode with SuffixTreeManager.
#
# This script uses LOCAL suffix decoding mode (server_mode=false):
...
#
# Compare with run_qwen25_1.5_suffix.sh which uses server mode (gRPC).
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen2.5_1.5b_suffix_local_mode' \
